...
-- LOG
--     $Log: struct.h,v $
 * Revision 1.1  1992/01/24  03:29:32  dvadura
...
typedef struct hcell {
	...
	char		*ht_value;	/* cell value if and */
	uint32		ht_hash;	/* actual hash_value of cell */
...
typedef struct tcell {
	...
	struct tcell	*ce_all;	/* link for grouping UPDATEALL cells*/

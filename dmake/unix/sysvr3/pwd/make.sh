...
mv state.o objects
cc -c -I. -Iunix -Iunix/sysvr3 -Iunix/sysvr3/pwd -O basename.c
...
objects/arlib.o objects/dirbrk.o objects/rmprq.o objects/ruletab.o objects/runargv.o objects/getcwd.o 
cp unix/sysvr3/pwd/startup.mk startup.mk

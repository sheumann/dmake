 ...
 */
    ...
    extern void _db_doprnt_  (char *format, ...);
	 extern void _db_printf_  (int _line_, char *keyword, char *format, ...);
	 extern void _db_push_    (char *control);
    extern void _db_pop_     (void);
    extern void _db_enter_   (char *_func_, char *_file_, int _line_, char
                              **_sfunc_, char **_sfile_, int *_slevel_);
    extern void _db_return_  (int _line_, char **_sfunc_, char **_sfile_,
                              int *_slevel_);
    extern void _db_pargs_   (int _line_, char *keyword);

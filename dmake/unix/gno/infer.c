...
#ifdef DBUG
void _dump_iset(char *name, ICELLPTR iset);
void _dump_dfa_stack(DFALINKPTR dfas, DFASETPTR  dfa_stack);
#endif

PUBLIC void
Infer_recipe( CELLPTR cp, CELLPTR setdirroot )/*
================================
...
static ICELLPTR
_derive_prerequisites( ICELLPTR ic, ICELLPTR *nnmp )/*
===================================
...
static DFALINKPTR
_dfa_subset(DFALINKPTR pdfa, register DFASETPTR stack)	/*
============================

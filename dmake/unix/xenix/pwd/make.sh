...
mv state.o objects
cc -c -I. -Iunix -Iunix/xenix -DM_XENIX -Iunix/xenix/pwd -O basename.c
...
objects/arlib.o objects/dirbrk.o objects/rmprq.o objects/ruletab.o objects/runargv.o objects/getcwd.o -lx 
cp unix/xenix/pwd/startup.mk startup.mk
